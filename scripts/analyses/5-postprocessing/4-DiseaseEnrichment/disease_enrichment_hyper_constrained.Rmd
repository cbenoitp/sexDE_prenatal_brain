...
constraint_data_filtered$LOEUF_bin <- cut(constraint_data_filtered$LOEUF, quantile(constraint_data_filtered$LOEUF, seq(0,1,0.1)), 
...
hdbr_sexDE_results <- merge(hdbr_sexDE_results, constraint_data_filtered, by.x = "ensemblID", by.y = "gene_id", all.x = TRUE)
...
hdbr_pseudotimeDE_results <- merge(hdbr_pseudotimeDE_results, constraint_data_filtered, by.x = "ensemblID", by.y = "gene_id", all.x = TRUE)
...
gtex_sexDE_results <- merge(gtex_sexDE_results, constraint_data_filtered, by.x = "ensemblID", by.y = "gene_id", all.x = TRUE)
...
gtex_pseudotimeDE_results <- merge(gtex_pseudotimeDE_results, constraint_data_filtered, by.x = "ensemblID", by.y = "gene_id", all.x = TRUE)
...
bayesResults_merged <- merge(bayesResults_merged, constraint_data_filtered, by.x = "ensemblID", by.y = "gene_id", all.x = TRUE)
