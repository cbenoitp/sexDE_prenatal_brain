...
write.table(enrichRes, file = "data/5-postprocessing/4-DiseaseEnrichment/results_disease_hyper/enrichment_results.txt", 
...
# save in file
write.table(enrichRes_formated_ctrlExpr_toSave, file = "data/5-postprocessing/4-DiseaseEnrichment/results_disease_hyper/enrichment_results_formated.txt", 
            quote = FALSE, row.names = FALSE, col.names = TRUE, sep = "\t")
```
