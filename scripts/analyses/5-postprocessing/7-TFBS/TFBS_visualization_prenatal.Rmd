---
title: "Visualize TFBS analysis results in prenatal brain"
...
# sex-DE results
femaleBiased_TF <- readRDS("data/5-postprocessing/7-TFBS/prenatal/Unibind_femaleBiased/lolaLocResults.RDS")
maleBiased_TF <- readRDS("data/5-postprocessing/7-TFBS/prenatal/Unibind_maleBiased/lolaLocResults.RDS")
# pseudotime-DE results
downReg_TF <- readRDS("data/5-postprocessing/7-TFBS/prenatal/Unibind_downReg/lolaLocResults.RDS")
upReg_TF <- readRDS("data/5-postprocessing/7-TFBS/prenatal/Unibind_upReg/lolaLocResults.RDS")
```


# Explore TFBS results
...
get_signif <- function(data_TF, qvalue_threshold = 0.05){
  ...
  TF_OR <- data_TF_signif %>% group_by(collection) %>% summarise(maxOddsRatio = max(oddsRatio))
...
Format prenatal sex-DE results.

```{r format_prenatal_sexDE_res, echo=FALSE}
# female biased
...
Save prenatal sex-DE results.

```{r save_prenatal_sexDE_res, echo=FALSE}
write.table(sexDE_TF_formatted, file = "data/5-postprocessing/7-TFBS/prenatal/sexDE_TF_results.txt",
            row.names = FALSE, col.names = TRUE, sep = "\t", quote = FALSE)
```

Format prenatal pseudotime-DE results.

```{r format_prenatal_pseudotimeDE_res, echo=FALSE}
# female biased
...
Save prenatal pseudotime-DE results.

```{r save_prenatal_pseudotimeDE_res, echo=FALSE}
write.table(pseudotimeDE_TF_formatted, file = "data/5-postprocessing/7-TFBS/prenatal/pseudotimeDE_TF_results.txt",
            row.names = FALSE, col.names = TRUE, sep = "\t", quote = FALSE)
```
