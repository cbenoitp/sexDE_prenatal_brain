---
title: "Visualize GTEx DE results using the pseudotime with RIN as covariate"
...
de_results <- read.table("data/4-GTEx/1-GTEx_analysis/brain_forebrain_v8_VoomDream_topTable_with_sva_ind_pseudotime_withRIN_interaction.txt",
                         header = TRUE)
```
...
Only 491/586 (84.8%) are also found in the analysis using the age bins.
...
ggsave(plot = p, namePlot, path = "images/4-GTEx/1-GTEx_analysis/pseudotime_analysis_withRIN/barplot/",
...
p <- EnhancedVolcano(de_results_autosomes,
                     ...
                     subtitle = "sex-DE analysis in GTEx",
                     caption = "autosomal genes")
p

# save plot
namePlot <- 'volcanoplot_colored_HDBR_dream_forebrain_pseudotime_sva_ind_interaction_sexDE_auto.png'
ggsave(namePlot, path = "images/4-GTEx/1-GTEx_analysis/pseudotime_analysis_withRIN/volcanoplot/",
...
load("data/4-GTEx/1-GTEx_analysis/brain_forebrain_v8_dream_counts_voom_phenotypes_pseudotime_withRIN_interaction.RData")
```

Compute variance attributable to each variable

```{r varpart, echo=FALSE}
form <- reformulate(c("(1|SEX)", "PSEUDOTIME", "RIN", "SEX:PSEUDOTIME", "(1|SUBJID)", paste0("X", 1:sva.obj$n.sv)))
...
ggsave("violinPlot_variancePartition.png", p,
       path = "images/4-GTEx/1-GTEx_analysis/pseudotime_analysis_withRIN/variancePartition/",
