---
title: "Visualize GTEx DE results with only svas as covariates"
...
de_results <- read.table("data/4-GTEx/1-GTEx_analysis/analysis_sva/brain_forebrain_v8_VoomDream_topTable_with_sva_ind.txt",
                         header = TRUE)
```
...
Only 968/1781 (54.4%) are also found in the original analysis.
...
ggsave(plot = p, namePlot, path = "images/4-GTEx/1-GTEx_analysis/analysis_sva/barplot/",
...
# save plot
namePlot <- 'volcanoplot_colored_HDBR_dream_forebrain_sva_ind_sexDE_auto.png'
ggsave(namePlot, path = "images/4-GTEx/1-GTEx_analysis/analysis_sva/volcanoplot/",
...
load("data/4-GTEx/1-GTEx_analysis/analysis_sva/brain_forebrain_v8_dream_counts_voom_phenotypes_sva.RData")
```

Compute variance attributable to each variable

```{r varpart, echo=FALSE}
form <- reformulate(c("SEX", "(1 | SUBJID)", paste0("X", 1:sva.obj$n.sv)))
...
ggsave("violinPlot_variancePartition.png", p,
       path = "images/4-GTEx/1-GTEx_analysis/analysis_sva/variancePartition/",
