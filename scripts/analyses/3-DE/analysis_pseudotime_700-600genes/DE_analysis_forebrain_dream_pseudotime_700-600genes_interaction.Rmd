---
title: "sex-DE dream analysis on HDBR forebrain samples using pseudotime (inferred with 100 genes between the 600 and 700 most variable genes) as covariate"
...
load("data/2-pseudotime/varInputGenes/forebrain_metadata_pseudotime_700-600genes.RData")
...
png('images/3-DE/analysis_pseudotime_700-600genes/trendplot/trendplot_VoomDream_forebrain_pseudotime_700-600genes_ind_interaction.png')
...
save(y, phenotypes, form, sva.obj, metadata,
     file = "data/3-DE/analysis_pseudotime_700-600genes/normCounts_dream_pseudotime_700-600genes_sva_ind_interaction_phenotypes.RData")
```
...
save(fitmm, file = "data/3-DE/analysis_pseudotime_700-600genes/fitmm_dream_pseudotime_700-600genes_sva_ind_interaction_phenotypes.RData")
```
...
write.table(fitmm2, 
            "data/3-DE/analysis_pseudotime_700-600genes/VoomDream_topTable_forebrain_pseudotime_700-600genes_sva_ind_interaction.txt", 
...
write.table(fitmm_interaction, 
            "data/3-DE/analysis_pseudotime_700-600genes/VoomDream_topTable_forebrain_pseudotime_700-600genes_sva_ind_interaction_term.txt", 
            col.names = TRUE, row.names = FALSE, quote = FALSE)
```
...
write.table(fitmm_pseudotime, 
            "data/3-DE/analysis_pseudotime_700-600genes/VoomDream_topTable_forebrain_pseudotime_700-600genes_sva_ind_interaction_pseudotime.txt", 
            col.names = TRUE, row.names = FALSE, quote = FALSE)
```
