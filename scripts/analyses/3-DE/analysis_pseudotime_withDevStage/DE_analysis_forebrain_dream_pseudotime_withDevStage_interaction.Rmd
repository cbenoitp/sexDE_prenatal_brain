---
title: "sex-DE dream analysis on HDBR forebrain samples using pseudotime (with developmental stages) as covariate"
...
load("data/2-pseudotime/analylsis_withDevStage/forebrain_metadata_pseudotime_withDevStage.RData")
...
png('images/3-DE/analysis_pseudotime_withDevStage/trendplot/trendplot_VoomDream_forebrain_pseudotime_ind_interaction.png')
...
save(y, phenotypes, form, sva.obj, metadata,
     file = "data/3-DE/analysis_pseudotime_withDevStage/normCounts_dream_pseudotime_sva_ind_interaction_phenotypes.RData")
```
...
save(fitmm, file = "data/3-DE/analysis_pseudotime_withDevStage/fitmm_dream_pseudotime_sva_ind_interaction_phenotypes.RData")
```
...
write.table(fitmm2, 
            "data/3-DE/analysis_pseudotime_withDevStage/VoomDream_topTable_forebrain_pseudotime_sva_ind_interaction.txt", 
...
write.table(fitmm_interaction, 
            "data/3-DE/analysis_pseudotime_withDevStage/VoomDream_topTable_forebrain_pseudotime_sva_ind_interaction_term.txt", 
            col.names = TRUE, row.names = FALSE, quote = FALSE)
```
...
write.table(fitmm_pseudotime, 
            "data/3-DE/analysis_pseudotime_withDevStage/VoomDream_topTable_forebrain_pseudotime_sva_ind_interaction_pseudotime.txt", 
            col.names = TRUE, row.names = FALSE, quote = FALSE)
```
