---
title: "Visualize DE results for analysis using pseudotime (with developmental stages)"
...
load("data/2-pseudotime/analysis_withDevStage/forebrain_pseudotime_analysis_withDevStage.RData")
# load sex-DE data
load("data/3-DE/analysis_pseudotime_withDevStage/normCounts_dream_pseudotime_sva_ind_interaction_phenotypes.RData")
de_results <- read.table("data/3-DE/analysis_pseudotime_withDevStage/VoomDream_topTable_forebrain_pseudotime_sva_ind_interaction.txt",
                         header = TRUE)
de_results_interaction <- read.table("data/3-DE/analysis_pseudotime_withDevStage/VoomDream_topTable_forebrain_pseudotime_sva_ind_interaction_term.txt", 
                                     header = TRUE)
de_results_pseudotime <- read.table("data/3-DE/analysis_pseudotime_withDevStage/VoomDream_topTable_forebrain_pseudotime_sva_ind_interaction_pseudotime.txt",
                                    header = TRUE)
```
...
All the 52 sex-DE genes from this new analysis were also found in the original analysis, but it represent only a small fraction (1.63%) of the 3187 sex-DE genes from the original analysis.
...
11786 genes (93.02%) from this new analysis were also pseudotime-DE in the original analysis.
...
ggsave(namePlot, 
       path = 'images/3-DE/analysis_pseudotime_withDevStage/pvalue_distrib/',
...
ggsave(plot = p, 
       path = 'images/3-DE/analysis_pseudotime_withDevStage/barplot/',
...
ggsave(namePlot, 
       path = "images/3-DE/analysis_pseudotime_withDevStage/volcanoplot/",
...
p
# save plot
png("images/3-DE/analysis_pseudotime_withDevStage/UpsetPlot/complexUpsetPlot_between_sexDE_pseudotimeDE_allGenes.png",
...
ggsave("violinPlot_variancePartition.png", p,
       path = "images/3-DE/analysis_pseudotime_withDevStage/variancePartition/",
