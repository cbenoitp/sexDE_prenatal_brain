---
title: "Visualize DE results for analysis using pseudotime (inferred with 1 sample per individual)"
...
# load sex-DE data
load("data/3-DE/analysis_1samplePerInd/normCounts_dream_pseudotime_1samplePerInd_sva_ind_interaction_phenotypes.RData")
de_results <- read.table("data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotime_1samplePerInd_sva_ind_interaction.txt",
                         header = TRUE)
de_results_interaction <- read.table("data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotime_1samplePerInd_sva_ind_interaction_term.txt", 
                                     header = TRUE)
de_results_pseudotime <- read.table("data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotime_1samplePerInd_sva_ind_interaction_pseudotime.txt",
                                    header = TRUE)
```
...
p
# save plot
png("images/3-DE/analysis_1samplePerInd/UpsetPlot/complexUpsetPlot_between_sexDE_pseudotimeDE_allGenes.png",
