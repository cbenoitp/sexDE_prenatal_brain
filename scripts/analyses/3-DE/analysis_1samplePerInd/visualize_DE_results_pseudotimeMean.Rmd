...
# load sex-DE data
load("data/3-DE/analysis_1samplePerInd/normCounts_dream_pseudotimeMean_sva_ind_interaction_phenotypes.RData")
de_results <- read.table("data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotimeMean_sva_ind_interaction.txt",
                         header = TRUE)
de_results_interaction <- read.table("data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotimeMean_sva_ind_interaction_term.txt", 
                                     header = TRUE)
de_results_pseudotime <- read.table("data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotimeMean_sva_ind_interaction_pseudotime.txt",
                                    header = TRUE)
```
...
p
# save plot
namePlot <- 'hist_pvalue_HDBR_dream_forebrain_pseudotimeMean_sva_ind_interaction.png'
ggsave(namePlot, 
...
p
# save plot
namePlot <- 'hist_pvalue_HDBR_dream_forebrain_pseudotimeMean_sva_ind_interaction_term.png'
ggsave(namePlot, 
       path = 'images/3-DE/analysis_1samplePerInd/pvalue_distrib/',
...
p
# save plot
namePlot <- 'hist_pvalue_HDBR_dream_forebrain_pseudotimeMean_sva_ind_interaction_pseudotime.png'
ggsave(namePlot, 
       path = 'images/3-DE/analysis_1samplePerInd/pvalue_distrib/',
       width = 15, height = 12, units = "cm")
```
...
p
# save plot
namePlot <- "barplot_nbr_sexDE_genes_pseudotimeMean.png"
ggsave(plot = p, 
...
p
# save plot
namePlot <- "barplot_nbr_pseudotimeDE_genes_pseudotimeMean.png"
ggsave(plot = p, 
       path = "images/3-DE/analysis_1samplePerInd/barplot/", 
...
p
# save plot
namePlot <- "barplot_nbr_interactionDE_genes_pseudotimeMean.png"
ggsave(plot = p, 
       path = "images/3-DE/analysis_1samplePerInd/barplot/", 
       namePlot, width = 8, height = 16, units = "cm")
```
...
# save plot
namePlot <- 'volcanoplot_colored_HDBR_dream_forebrain_pseudotimeMean_sva_ind_interaction_sexDE_auto.png'
ggsave(namePlot, 
...
# save plot
namePlot <- 'volcanoplot_colored_HDBR_dream_forebrain_pseudotimeMean_sva_ind_interaction_pseudotimeDE.png'
ggsave(namePlot, 
       path = "images/3-DE/analysis_1samplePerInd/volcanoplot/",
...
# save plot
namePlot <- 'volcanoplot_colored_HDBR_dream_forebrain_pseudotimeMean_sva_ind_interaction_interactionDE_auto.png'
ggsave(namePlot, 
       path = "images/3-DE/analysis_1samplePerInd/volcanoplot/",
       width = 12, height = 15, units = "cm")
```
...
p
# save plot
png("images/3-DE/analysis_1samplePerInd/UpsetPlot/complexUpsetPlot_between_sexDE_pseudotimeDE_allGenes_pseudotimeMean.png",
...
p
ggsave("violinPlot_variancePartition_pseudotimeMean.png", p,
