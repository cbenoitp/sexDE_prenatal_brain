---
title: "Sex-DE analysis using same pseudotime for each individuals: mean pseudotime"
...
png('images/3-DE/analysis_1samplePerInd/trendplot/trendplot_VoomDream_forebrain_pseudotimeMean_ind_interaction.png')
...
save(y, phenotypes, form, sva.obj, metadata,
     file = "data/3-DE/analysis_1samplePerInd/normCounts_dream_pseudotimeMean_sva_ind_interaction_phenotypes.RData")
```
...
save(fitmm, file = "data/3-DE/analysis_1samplePerInd/fitmm_dream_pseudotimeMean_sva_ind_interaction_phenotypes.RData")
```
...
write.table(fitmm2, 
            "data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotimeMean_sva_ind_interaction.txt", 
...
write.table(fitmm_interaction, 
            "data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotimeMean_sva_ind_interaction_term.txt", 
            col.names = TRUE, row.names = FALSE, quote = FALSE)
```
...
write.table(fitmm_pseudotime, 
            "data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotimeMean_sva_ind_interaction_pseudotime.txt", 
            col.names = TRUE, row.names = FALSE, quote = FALSE)
```
