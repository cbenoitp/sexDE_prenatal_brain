---
title: "Visualize DE results for analysis using mean pseudotime"
...
# load and format pseudotime data
...
# load sex-DE data
load("data/3-DE/analysis_1samplePerInd/normCounts_dream_pseudotimeMean_sva_interaction_phenotypes.RData")
de_results <- read.table("data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotimeMean_sva_interaction.txt",
                         header = TRUE)
de_results_interaction <- read.table("data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotimeMean_sva_interaction_term.txt", 
                                     header = TRUE)
de_results_pseudotime <- read.table("data/3-DE/analysis_1samplePerInd/VoomDream_topTable_forebrain_pseudotimeMean_sva_interaction_pseudotime.txt",
                                    header = TRUE)
```
...
3127/7025 sex-DE genes from this new analysis were also found in the original analysis, representing a large fraction (98.11%) of the 3187 sex-DE genes from the original analysis.
...
11089 genes (89.84%) from this new analysis were also pseudotime-DE in the original analysis.
...
p
# save plot
namePlot <- 'hist_pvalue_HDBR_dream_forebrain_pseudotimeMean_sva_interaction_noInd.png'
ggsave(namePlot, 
...
p
# save plot
namePlot <- 'hist_pvalue_HDBR_dream_forebrain_pseudotimeMean_sva_interaction_term_noInd.png'
ggsave(namePlot, 
       path = 'images/3-DE/analysis_1samplePerInd/pvalue_distrib/',
...
p
# save plot
namePlot <- 'hist_pvalue_HDBR_dream_forebrain_pseudotimeMean_sva_interaction_pseudotime_noInd.png'
ggsave(namePlot, 
       path = 'images/3-DE/analysis_1samplePerInd/pvalue_distrib/',
       width = 15, height = 12, units = "cm")
```
...
p
# save plot
namePlot <- "barplot_nbr_sexDE_genes_pseudotimeMean_noInd.png"
ggsave(plot = p, 
...
p
# save plot
namePlot <- "barplot_nbr_pseudotimeDE_genes_pseudotimeMean_noInd.png"
ggsave(plot = p, 
       path = "images/3-DE/analysis_1samplePerInd/barplot/", 
...
p
# save plot
namePlot <- "barplot_nbr_interactionDE_genes_pseudotimeMean_noInd.png"
ggsave(plot = p, 
       path = "images/3-DE/analysis_1samplePerInd/barplot/", 
       namePlot, width = 8, height = 16, units = "cm")
```
...
# save plot
namePlot <- 'volcanoplot_colored_HDBR_dream_forebrain_pseudotimeMean_sva_interaction_sexDE_auto_noInd.png'
ggsave(namePlot, 
...
# save plot
namePlot <- 'volcanoplot_colored_HDBR_dream_forebrain_pseudotimeMean_sva_interaction_pseudotimeDE_noInd.png'
ggsave(namePlot, 
       path = "images/3-DE/analysis_1samplePerInd/volcanoplot/",
...
# save plot
namePlot <- 'volcanoplot_colored_HDBR_dream_forebrain_pseudotimeMean_sva_interaction_interactionDE_auto_noInd.png'
ggsave(namePlot, 
       path = "images/3-DE/analysis_1samplePerInd/volcanoplot/",
       width = 12, height = 15, units = "cm")
```
...
p
# save plot
png("images/3-DE/analysis_1samplePerInd/UpsetPlot/complexUpsetPlot_between_sexDE_pseudotimeDE_allGenes_pseudotimeMean_noInd.png",
...
p
ggsave("violinPlot_variancePartition_pseudotimeMean_noInd.png", p,
