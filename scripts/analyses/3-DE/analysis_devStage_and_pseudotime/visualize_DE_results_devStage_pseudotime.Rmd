---
title: "Visualize DE results of the analysis including both pseudotime and developmental stages"
...
# load sex-DE data
load("data/3-DE/analysis_devStage_and_pseudotime/normCounts_dream_pseudotime_devStage_sva_ind_interaction_phenotypes.RData")
de_results <- read.table("data/3-DE/analysis_devStage_and_pseudotime/VoomDream_topTable_forebrain_pseudotime_devStage_sva_ind_interaction.txt",
                         header = TRUE)
de_results_interaction <- read.table("data/3-DE/analysis_devStage_and_pseudotime/VoomDream_topTable_forebrain_pseudotime_devStage_sva_ind_interaction_term.txt", 
                                     header = TRUE)
de_results_pseudotime <- read.table("data/3-DE/analysis_devStage_and_pseudotime/VoomDream_topTable_forebrain_pseudotime_devStage_sva_ind_interaction_pseudotime.txt",
                                    header = TRUE)
```
...
403/545 sex-DE genes from this new analysis were also found in the original analysis, representing a large fraction (73.94%) of the 545 sex-DE genes from the original analysis.
...
10582 genes (88.80%) from this new analysis were also pseudotime-DE in the original analysis.
...
ggsave(namePlot, 
       path = 'images/3-DE/analysis_devStage_and_pseudotime/pvalue_distrib/',
...
ggsave(plot = p, 
       path = 'images/3-DE/analysis_devStage_and_pseudotime/barplot/',
...
ggsave(namePlot, 
       path = "images/3-DE/analysis_devStage_and_pseudotime/volcanoplot/",
...
p
# save plot
png("images/3-DE/analysis_devStage_and_pseudotime/UpsetPlot/complexUpsetPlot_between_sexDE_pseudotimeDE_allGenes.png",
...
form <- reformulate(c("(1|Sex)", "pseudotime", "(1|DevStage)", "Sex:pseudotime", "(1 | Individual)", paste0("X", 1:sva.obj$n.sv)))
...
ggsave("violinPlot_variancePartition.png", p,
       path = "images/3-DE/analysis_devStage_and_pseudotime/variancePartition/",
